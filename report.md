...
Также видно, что хотя метод Рунге-Кутты-Фельберга 5-го порядка неустойчив по сравнению с неявными схемами, но его запас устойчивости больше чем у метода Рунге-Кутты 4-го порядка.
