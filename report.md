...
![](img/mainImplVsXpl.png){ width=200px }
...
Видно, что при малых $a$ (в зависимости от параметров $b$ и $c$) происходит затухание колебаний. В то время, как при больших $a$ периодичность $x(t)$ сохраняется
